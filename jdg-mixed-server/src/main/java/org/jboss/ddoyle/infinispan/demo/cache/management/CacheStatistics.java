package org.jboss.ddoyle.infinispan.demo.cache.management;
...
//import org.jboss.ddoyle.infinispan.demo.xsite.XSiteFailureManager;
...
public class CacheStatistics implements CacheStatisticsMBean {
	...
	private static final String mBeanName = "org.jboss.ddoyle.infinispan.demo.cache.management:type=CacheStatistics";
...
//	@Inject
//	private XSiteFailureManager xsiteFailureManager;
...
/*	
	@Override
	public List<String> xsiteFailures(String site) {
		//TODO: Use xsitefailuremanager to display list of all failures.
		List<XSiteFailureEvent> xsiteFailureEvents = xsiteFailureManager.getXSiteFailures(cacheManager.getCache().getName(), site);
		List<String> failureEventStrings = new ArrayList<>();
		for (XSiteFailureEvent nextEvent: xsiteFailureEvents) {
			failureEventStrings.add(nextEvent.toString());
		}
		return failureEventStrings;
	}
*/
